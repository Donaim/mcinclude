...
def compile_run(main_source):
    subprocess.check_call(['py', 'mxxbuild.py', src_dir, '++no-link', '++exclude', 'main.cpp']) # compile only, but not main.cpp
    ...
    subprocess.check_call(['g++', '-c', main_source, '-o', my_object_path]) # compile only this file
